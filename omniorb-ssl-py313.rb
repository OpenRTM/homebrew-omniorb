...
#
# This is the formula for omniORBpy on python3.13
# To use this formula/bottle, switch python 3.x to python 3.13.
# $ brew unlink python3.x (unlink current python)
# $ brew link python@3.13 omniorb-ssl-y310
#============================================================
class OmniorbSslPy313 < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any, arm64_tahoe: "bf4d776a44e0c5c5d36e9a9a25dfa68749439329e2e984127d2dd4e54274ebe8"
    rebuild 1
    sha256 cellar: :any, arm64_sequoia: "d060e55502d1db40fe17c66b1852e2e9af6b32650afb2fdef3e127922c54813c"
  end
